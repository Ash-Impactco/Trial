...
<section id="internship">
  ...
  <div class="experience-entry">
    <h3>SMOOV (Smart Mobility Operating Autonomous Vehicle), Netherlands</h3>
    <p class="date">Apr 2022 - Jul 2022</p>
    <p>
      StartUp specialising in creating fast & reliable charging location apps for EV drivers through traffic analysis, road quality, 
      estimation, urban planning & seamless troubleshooting, thereby reversing Nitrogen Crisis with AMC & migration to cities.
    </p>
    <p>
      Presented a dissertation on ‘The Integration of Autonomous Mobility Commerce into the Current Dutch Infrastructure’ that studied the social 
      acceptance of the circulation of autonomous commerce for 50 respondents; concluded that 73% of people were in for the notion of 
      autonomous commerce.
    </p>
    <p>
      Analyzed data collected through surveys and interviews with 50 civilians aged between 25 and 75 on the social, behavioural and technical 
      acceptance of AV Technology, fully adhering to the policy and regulations in the Netherlands.
    </p>
    <p>
      Administered Data Urban Planning with Imagery Data collected through ARC Gis and LiDAR point clouds and analyzed the existing imagery 
      data through a built-in-street smart.
    </p>
  </div>
</section>
...
<section id="projects">
  ...
  <div class="experience-entry">
    <h3>Upcoming Geothermal Heat Grid - A Case Study in Leeuwarden, Netherlands</h3>
    <p class="date">Feb 2022 - Apr 2022</p>
    <p>
      Collected data from interviewing 100 respondents on their social concerns regarding the transition towards integrating geothermal energy
      into the existing heat grid in the Netherlands. Initiated qualitative data processing through the conceptual framework of DESSIN-ESS.
    </p>
    <p>
      Findings were published by Omrop. 
      <a href="https://www.omropfryslan.nl/nl/nieuws/1144457/internationale-studenten-duurzame-aanpak-infryslan-is-mogelijk" target="_blank">
        https://www.omropfryslan.nl/nl/nieuws/1144457/internationale-studenten-duurzame-aanpak-infryslan-is-mogelijk
      </a>
    </p>
  </div>

  <div class="experience-entry">
    <h3>Coral Bleaching Status in the Andaman Islands, India</h3>
    <p class="date">Dec 2017 - Feb 2018</p>
    <p>
      Discovered that the tenacity of SST (Sea Surface Temperature) is 1°C more than the maximum monthly temperature which led to a degradation of
      zooxanthellae and algae symbiosis. Coral Bleaching Alert System (CBAS), the thermal stress is assessed with satellite-derived SST.
    </p>
    <p>
      Studied Acropora and presented its degradation rate and increase in SST to ANET (Andaman Nicobar Environment team) for future
      research, the Indian Wildlife department and the Indian Coast Guard of Andaman.
    </p>
  </div>
</section>
...
<li>Project Management - Google</li>
    ...
    <li>ISO 14001:2015 Lead Auditor for Environmental Management</li>
</ul>
</div>
</section>
...
<section id="languages">
  ...
  <ul class="language-list">
    <li>Fluent in English, Tamil, Hindi, and Kannada</li>
    <li>Intermediate in Portuguese</li>
    <li>Elementary in Dutch</li>
    <li>Learning Bahasa</li>
  </ul>
</section>
...
<section id="skills">
  ...
  <div class="skill-category">
    <h3>Marketing & DemandGen</h3>
    <p>HubSpot · Salesforce · Mailchimp · Zendesk · Cold outreach</p>
  </div>

  <div class="skill-category">
    <h3>Analytics & Reporting</h3>
    <p>SQL · PowerBI · CRM · Excel · Google Sheets</p>
  </div>

  <div class="skill-category">
    <h3>Project & Stakeholder Mgmt</h3>
    <p>Jira/Kanban · Agile · SOP development</p>
  </div>

  <div class="skill-category">
    <h3>Sustainability & Carbon</h3>
    <p>GIS · EIA · ISO14001 · GHG accounting · NEBOSH</p>
  </div>
</section>
